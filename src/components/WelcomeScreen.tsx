      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="mb-8">
          ...
          <p className="mt-4 text-xl text-muted-foreground max-w-2xl mx-auto">
            Professional moving services made simple. Get an instant quote and book your move in minutes.
          </p>
        </div>

        {/* Features Grid */}
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-card rounded-lg p-6 shadow-soft hover:shadow-medium transition-all duration-300">
