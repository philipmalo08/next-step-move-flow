              ...
              <div className="inline-flex flex-col items-center gap-1">
                ...
                <div className="flex items-center text-4xl md:text-5xl font-bold">
                  <span className="text-blue-600 relative">
                    N
                    <svg className="absolute -top-2 -right-0 w-6 h-6 md:w-8 md:h-8" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <svg className="ml-0 w-6 h-6 md:w-8 md:h-8 text-black" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div className="flex items-center text-4xl md:text-5xl font-bold">
                  ...
                  <span className="text-blue-600">T</span>
                  <svg className="ml-0 w-6 h-6 md:w-8 md:h-8 text-blue-600" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M2 12L22 12M22 12L16 6M22 12L16 18" stroke="currentColor" strokeWidth="3" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
              </div>
