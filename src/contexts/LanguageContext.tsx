...
const translations = {
  ...
  fr: {
    ...
    'admin.created': 'Créé',
    'admin.baseServiceFee': 'Frais de Service de Base',
    'admin.distanceRate': 'Tarif Distance',
    'admin.serviceTierRates': 'Tarifs de Niveau de Service',
    'admin.taxRates': 'Taux de Taxe',
    'admin.gstRate': 'Taux TPS',
    'admin.qstRate': 'Taux TVQ',
    'admin.savePricingSettings': 'Sauvegarder les Paramètres de Prix',
    'admin.resetToDefaults': 'Réinitialiser aux Valeurs par Défaut',
    'admin.pricingPreview': 'Aperçu des Prix',
    'admin.noUsersFound': 'Aucun utilisateur trouvé.',
    'admin.filters': 'Filtres',
    'admin.searchBookings': 'Rechercher par nom de client, email, ou ID de réservation...',
    'admin.filterByStatus': 'Filtrer par statut',
    'admin.allStatus': 'Tous les Statuts',
    'admin.confirmed': 'Confirmé',
    'admin.assigned': 'Assigné',
    'admin.inProgress': 'En Cours',
    'admin.completed': 'Terminé',
    'admin.cancelled': 'Annulé',
    'admin.pickup': 'Ramassage',
    'admin.dropoff': 'Livraison',
    'admin.assignedDriver': 'Chauffeur Assigné',
    'admin.generating': 'Génération...',
    'admin.downloadPdf': 'Télécharger PDF',
    'admin.viewDetails': 'Voir Détails',
    'admin.noBookingsFound': 'Aucune réservation trouvée correspondant à vos critères.',
    'admin.addDriver': 'Ajouter Chauffeur',
    'admin.addNewDriver': 'Ajouter Nouveau Chauffeur',
    'admin.phone': 'Téléphone',
    'admin.licenseNumber': 'Numéro de Permis',
    'admin.vehicleType': 'Type de Véhicule',
    'admin.selectType': 'Sélectionner le type',
    'admin.truck': 'Camion',
    'admin.van': 'Fourgonnette',
    'admin.trailer': 'Remorque',
    'admin.vehicleModel': 'Modèle de Véhicule',
    'admin.searchDrivers': 'Rechercher chauffeurs par nom ou email...',
    'admin.available': 'Disponible',
    'admin.unavailable': 'Indisponible',
    'admin.license': 'Permis',
    'admin.vehicle': 'Véhicule',
    'admin.setUnavailable': 'Marquer Indisponible',
    'admin.setAvailable': 'Marquer Disponible',
    'admin.noDriversFound': 'Aucun chauffeur trouvé correspondant à votre recherche.',
    'admin.allTickets': 'Tous les Tickets',
    'admin.open': 'Ouvert',
    'admin.resolved': 'Résolu',
    'admin.closed': 'Fermé',
    'admin.tickets': 'tickets',
    'admin.noSupportTickets': 'Aucun ticket de support trouvé.',
    'admin.no': 'Aucun',
    'admin.ticketsFound': 'tickets trouvés.',
    'admin.weeklyAvailability': 'Disponibilité Hebdomadaire',
    'admin.weeklyAvailabilityDesc': 'Définir les heures d\'ouverture régulières de votre entreprise pour chaque jour de la semaine',
    'admin.addNewTimeSlot': 'Ajouter Nouveau Créneau Horaire',
    'admin.dayOfWeek': 'Jour de la Semaine',
    'admin.startTime': 'Heure de Début',
    'admin.endTime': 'Heure de Fin',
    'admin.addTimeSlot': 'Ajouter Créneau Horaire',
    'admin.blackoutDates': 'Dates d\'Indisponibilité',
    'admin.blackoutDatesDesc': 'Définir des dates spécifiques où l\'entreprise est indisponible (congés, maintenance, etc.)',
    'admin.addBlackoutDate': 'Ajouter Date d\'Indisponibilité',
    'admin.addBlackoutDateDesc': 'Sélectionner une date où l\'entreprise sera indisponible',
    'admin.reasonOptional': 'Raison (optionnel)',
    'admin.reasonPlaceholder': 'ex. Congé, Maintenance',
    'admin.noBlackoutDates': 'Aucune date d\'indisponibilité définie',
